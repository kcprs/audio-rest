% SPECTRALPITCH Audio restoration through spectral modelling with
% pitch tracking (see section 6.3 in the report)
...
polyOrd = 3; % Polynomial order to be used for trajectory interpolation
fitRange = 4; % Number of fitting points at either side of the gap

% Plotting settings
xRange = 4; % Plotting range on x axis. Value of 1 corresponds to gap length.
freqLim = [0, 20000] / 1000; % Freq range
